...
Read the https://download.eclipse.org/microprofile/microprofile-graphql-2.0/microprofile-graphql-spec-2.0.html[MicroProfile GraphQL 2.0] Specification (latest release).

> NOTE: This branch includes our current work on v2.1 of the specification.
...
On 7 November 2018, the GraphQL project was moved from Facebook to the newly-established https://www.linuxfoundation.org/press/press-release/intent_to_form_graphql[GraphQL Foundation], hosted by the non-profit https://www.linuxfoundation.org/[Linux Foundation].    
